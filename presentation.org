...
- For the purpose of TBAM, we will not focus heavily on the motion planning problem.
  Given a task plan, allocation, and schedule, we assume that the motion is feasible.
